...
public class BloodLogBlock extends TheShadeModModElements.ModElement {
	@ObjectHolder("the_shade_mod:blood_log")
	public static final Block block = null;
	public BloodLogBlock(TheShadeModModElements instance) {
		super(instance, 97);
	}
