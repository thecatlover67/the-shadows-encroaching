...
public class BloodwaterBlock extends TheShadeModModElements.ModElement {
	@ObjectHolder("the_shade_mod:bloodwater")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("the_shade_mod:bloodwater_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public BloodwaterBlock(TheShadeModModElements instance) {
		super(instance, 114);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes
						.builder(new ResourceLocation("the_shade_mod:blocks/blood_still"), new ResourceLocation("the_shade_mod:blocks/bloodflow"))
						.luminosity(0).density(1000).viscosity(3000)).bucket(() -> bucket).block(() -> block);
		still = (FlowingFluid) new ForgeFlowingFluid.Source(fluidproperties).setRegistryName("bloodwater");
		flowing = (FlowingFluid) new ForgeFlowingFluid.Flowing(fluidproperties).setRegistryName("bloodwater_flowing");
		elements.blocks.add(() -> new FlowingFluidBlock(still, Block.Properties.create(Material.WATER)) {
		}.setRegistryName("bloodwater"));
		elements.items.add(() -> new BucketItem(still, new Item.Properties().containerItem(Items.BUCKET).maxStackSize(1).group(ItemGroup.MISC))
				.setRegistryName("bloodwater_bucket"));
	}
