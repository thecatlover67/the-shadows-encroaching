...
public class PurplemossybricksBlock extends TheShadeModModElements.ModElement {
	@ObjectHolder("the_shade_mod:purplemossybricks")
	public static final Block block = null;
	public PurplemossybricksBlock(TheShadeModModElements instance) {
		super(instance, 74);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("purplemossybricks");
		}
