...
public class ShadesaplingBlock extends TheShadeModModElements.ModElement {
	@ObjectHolder("the_shade_mod:shadesapling")
	public static final Block block = null;
	@ObjectHolder("the_shade_mod:shadesapling")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public ShadesaplingBlock(TheShadeModModElements instance) {
		super(instance, 46);
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("shadesapling"));
	}
