...
public class ShadewoodlogBlock extends TheShadeModModElements.ModElement {
	@ObjectHolder("the_shade_mod:shadewoodlog")
	public static final Block block = null;
	public ShadewoodlogBlock(TheShadeModModElements instance) {
		super(instance, 5);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(45f, 10f).lightValue(0).harvestLevel(3)
					.harvestTool(ToolType.AXE));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("shadewoodlog");
		}
