...
public class ShadewoodslabBlock extends TheShadeModModElements.ModElement {
	@ObjectHolder("the_shade_mod:shadewoodslab")
	public static final Block block = null;
	public ShadewoodslabBlock(TheShadeModModElements instance) {
		super(instance, 21);
	}
