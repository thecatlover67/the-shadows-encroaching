...
public class SpineStalkBlock extends TheShadeModModElements.ModElement {
	@ObjectHolder("the_shade_mod:spine_stalk")
	public static final Block block = null;
	public SpineStalkBlock(TheShadeModModElements instance) {
		super(instance, 90);
	}
	...
	public static class BlockCustomFlower extends SugarCaneBlock {
		public BlockCustomFlower() {
			super(Block.Properties.create(Material.PLANTS).tickRandomly().doesNotBlockMovement().sound(SoundType.SCAFFOLDING)
					.hardnessAndResistance(1.5f, 0f).lightValue(0));
			setRegistryName("spine_stalk");
		}
