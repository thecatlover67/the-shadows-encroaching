...
public class DiamondhammerItem extends TheShadeModModElements.ModElement {
	@ObjectHolder("the_shade_mod:diamondhammer")
	public static final Item block = null;
	public DiamondhammerItem(TheShadeModModElements instance) {
		super(instance, 92);
	}
