...
public class FleshballitemItem extends TheShadeModModElements.ModElement {
	@ObjectHolder("the_shade_mod:fleshballitem")
	public static final Item block = null;
	public FleshballitemItem(TheShadeModModElements instance) {
		super(instance, 7);
	}
