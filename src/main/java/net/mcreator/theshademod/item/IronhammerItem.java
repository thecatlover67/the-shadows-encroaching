...
public class IronhammerItem extends TheShadeModModElements.ModElement {
	@ObjectHolder("the_shade_mod:ironhammer")
	public static final Item block = null;
	public IronhammerItem(TheShadeModModElements instance) {
		super(instance, 50);
	}
