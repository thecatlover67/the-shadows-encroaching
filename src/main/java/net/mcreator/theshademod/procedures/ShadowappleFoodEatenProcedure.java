...
public class ShadowappleFoodEatenProcedure extends TheShadeModModElements.ModElement {
	public ShadowappleFoodEatenProcedure(TheShadeModModElements instance) {
		super(instance, 93);
	}
