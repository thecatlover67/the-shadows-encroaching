...
public class BloodtreeStructure extends TheShadeModModElements.ModElement {
	public BloodtreeStructure(TheShadeModModElements instance) {
		super(instance, 110);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 40000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("the_shade_mod", "blood_tree"));
						if (template == null)
							return false;
