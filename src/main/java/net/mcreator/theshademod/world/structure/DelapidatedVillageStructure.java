...
package net.mcreator.theshademod.world.structure;
...
public class DelapidatedVillageStructure extends TheShadeModModElements.ModElement {
	public DelapidatedVillageStructure(TheShadeModModElements instance) {
		super(instance, 101);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 20000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("the_shade_mod", "delapvillage2"));
						if (template == null)
							return false;
