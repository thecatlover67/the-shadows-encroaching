...
public class FleshribStructure extends TheShadeModModElements.ModElement {
	public FleshribStructure(TheShadeModModElements instance) {
		super(instance, 113);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 100000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("the_shade_mod", "bone_rib"));
						if (template == null)
							return false;
