...
public class Journalcamp1Structure extends TheShadeModModElements.ModElement {
	public Journalcamp1Structure(TheShadeModModElements instance) {
		super(instance, 111);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 1000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("the_shade_mod", "campsite_1"));
						if (template == null)
							return false;
